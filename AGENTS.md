# portfolio-lab — agent guide

Max-Sharpe portfolio studio
...
- Deploy: `astro build && wrangler pages deploy dist --project-name portfolio-lab --branch main --commit-dirty=true`.
